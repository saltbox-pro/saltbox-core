                ...
                AggregatedField(
                    ...
                    stages=[
                        ...
                        LookupAggregationStage(
                            ...
                            local_field='_id',
                            foreign_field='task_id',
                            as_field='minions_count.blocked',
                            pipeline=[{'$match': {'status': 'blocked'}}, {'$count': 'count'}],
                        ),
                        LookupAggregationStage(
                            from_collection='task_minions',
                            local_field='_id',
                            foreign_field='task_id',
                            as_field='minions_count.unreachable',
                            pipeline=[{'$match': {'status': 'unreachable'}}, {'$count': 'count'}],
                        ),
                        LookupAggregationStage(
                            from_collection='task_minions',
                            local_field='_id',
                        ...
                        UnwindAggregationStage(path='$minions_count.blocked', preserve_null_and_empty_arrays=True),
                        UnwindAggregationStage(path='$minions_count.unreachable', preserve_null_and_empty_arrays=True),
                        ...
                        AddFieldsAggregationStage(
                            fields={
                                ...
                                'minions_count.blocked': {'$ifNull': ['$minions_count.blocked.count', 0]},
                                'minions_count.unreachable': {'$ifNull': ['$minions_count.unreachable.count', 0]},
