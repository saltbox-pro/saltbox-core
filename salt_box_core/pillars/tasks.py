...
from salt_box_core.pillars.schemas.event_bus_schemas import PillarClearCacheMessage
...
async def update_pillar_cache(master_id: str, tgt: str, tgt_type: str) -> Any:
    return await send_message_and_wait_response_to_master(
        message=PillarClearCacheMessage(master=master_id, tgt=tgt, tgt_type=tgt_type),
